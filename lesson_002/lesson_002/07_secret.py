...
# first_message = 'квевтфпп6щ3стмзалтнмаршгб5длгуча'[3]         # TODO: там написано 4ая буква. а Т - это пятая буква
# print(first_message)
# second_message = 'дьсеы6лц2бане4т64ь4б3ущея6втщл6б'[9:13]    # TODO: тут та же проблема: в условии говорят называют номера букв, а не индексы.
# print(second_message)                                         #       индексы самому надо посчитать на основе номеров
# third_message = 'т3пплвце1н3и2кд4лы12чф1ап3бкычаь'[5:15:2]
# print(third_message)
# fourth_message = 'ьд5фму3е жородт 9г686буиимыкучшсал'[12:6:-1]
# print(fourth_message)
#fifth_message = 'бсц59мегщ2лятьаьг енеды в9фк9ехб1а'[20:15:-1]
...
#Ура, я это сделал! Спасибо за подсказки и советы) Опять оставляю для себя памятку)

# на здоровье) хорошая работа
